...
insert into room(id, discount, floor, num_of_beds, number, reserved, room_type, hotel_id, room_price) values (-1, 0, 1, 1, 101, 0, 0, 0, 10);
insert into room(id, discount, floor, num_of_beds, number, reserved, room_type, hotel_id, room_price) values (-2, 0, 1, 2, 102, 0, 1, 0, 18);
insert into room(id, discount, floor, num_of_beds, number, reserved, room_type, hotel_id, room_price) values (-3, 0, 1, 2, 103, 0, 1, 0, 20);
