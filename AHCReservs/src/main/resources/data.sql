...
insert into hadditional_service(id, service, hotel_id, service_price_id) values (-1, 0, 0, -3);
insert into hadditional_service(id, service, hotel_id, service_price_id) values (-2, 1, 0, -1);

insert into price(id, currency, price) values (-1, 0, 15);
insert into price(id, currency, price) values (-2, 0, 25);
insert into price(id, currency, price) values (-3, 0, 10);
